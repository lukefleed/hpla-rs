! PSBLAS two-pass Lanczos stub for f(A)b.
!
...
!
! Every O(n) buffer belongs to the context allocated in setup; execute
! reuses them without any fresh allocation. Criterion's timing window
! measures execute in isolation, matching the faer lanczos_into /
! lanczos_two_pass_into allocation policy.
...
end module psblas_lanczos_two_pass
